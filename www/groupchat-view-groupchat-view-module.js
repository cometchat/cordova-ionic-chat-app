...
var GroupchatViewPage = /** @class */ (function () {
    ...
    GroupchatViewPage.prototype.addTypingListner = function () {
        var _this = this;
        var listenerId = "GroupTypingListner";
        _cometchat_pro_chat__WEBPACK_IMPORTED_MODULE_3__["CometChat"].addMessageListener(listenerId, new _cometchat_pro_chat__WEBPACK_IMPORTED_MODULE_3__["CometChat"].MessageListener({
            onTypingStarted: function (typingIndicator) {
                console.log("Typing started :", typingIndicator);
                console.log("Typing uid :", typingIndicator.sender.uid);
                if (typingIndicator.sender.uid != _this.loggedInUserData.uid) {
                    console.log("update the indicators");
                    var name = typingIndicator.sender.name + " is typing...";
                    _this.currentTypingUserIndicator = name;
            ...
            onTypingEnded: function (typingIndicator) {
                ...
                if (typingIndicator.sender.uid != _this.loggedInUserData.uid) {
                    _this.currentTypingUserIndicator = "";
                }
            }
        }));
    };
    ...
    GroupchatViewPage.prototype.checkBlur = function () {
        console.log("checkBlur called");
        var receiverId = this.currentGroupData.guid;
        var receiverType = _cometchat_pro_chat__WEBPACK_IMPORTED_MODULE_3__["CometChat"].RECEIVER_TYPE.GROUP;
    ...
    GroupchatViewPage.prototype.checkFocus = function () {
        console.log("checkFocus called");
    };
    GroupchatViewPage.prototype.checkInput = function () {
